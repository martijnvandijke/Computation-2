...
#endif
static const char *ng0 = "C:/Users/martijn/Documents/GitHub/Computation-2/Work_Folder_Mips/mMips/mmips_2/mmips/verilog/alu.v";
static int ng1[] = {0, 0};
...
LAB87:    if (*((unsigned int *)t6) < *((unsigned int *)t7))
        goto LAB85;
...
LAB95:    if (*((unsigned int *)t5) > *((unsigned int *)t6))
        goto LAB93;
