...
LAB79:    if (*((unsigned int *)t6) < *((unsigned int *)t10))
        goto LAB77;
...
LAB98:    if (*((unsigned int *)t6) < *((unsigned int *)t7))
        goto LAB96;
