...
#endif
static const char *ng0 = "D:/Computation-2/Work_Folder_Mips/mMips/mmips_5_Final/mmips/verilog/alu.v";
static int ng1[] = {0, 0};
...
LAB93:    if (*((unsigned int *)t6) < *((unsigned int *)t10))
        goto LAB91;
...
LAB119:    if (*((unsigned int *)t6) < *((unsigned int *)t7))
        goto LAB117;
...
LAB127:    if (*((unsigned int *)t5) > *((unsigned int *)t6))
        goto LAB125;
...
extern void work_m_00000000000008269599_0886308060_init()
{
	...
	xsi_register_didat("work_m_00000000000008269599_0886308060", "isim/mMIPS_isim_beh.exe.sim/work/m_00000000000008269599_0886308060.didat");
